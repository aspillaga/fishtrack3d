...
One additional object, which is created in one steps during the application of the method, is also provided. Despite we provide all the code to create it, one may want to skip this step when following this guide, as it is slow and memory consuming or requires external software like `GRASS`.
